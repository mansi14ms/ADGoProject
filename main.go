...
func returnAll(w http.ResponseWriter, r *http.Request) {
	...
	//creating a collection of all the documents
	...
	if err != nil {
		...
		str := string(b)
		//if there are no documents in database
		if str == "null" {
...
func createNewUserDB(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		str := string(b)
		//If record with that id is not present, then only update
		if str == "null" {
...
func returnSingleUser(w http.ResponseWriter, r *http.Request) {
	...
	//to match with the ids
	filter = bson.D{
		{"id", bson.D{{"$eq", i}}},
	}

	//to show the data without the -id generated by mongoDB
	option = bson.D{{"_id", 0}}
...
func deleteUser(w http.ResponseWriter, r *http.Request) {
	...
	//delete the one with the given id
...
func updateUserDataDB(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		//if the given id is not present don't process further
		str := string(b)
		if str == "null" {
			fmt.Fprintf(w, "No user foundd")
		} else {
			...
			fmt.Fprintf(w, str)
			//present so delete the old document
			res, err := collection.DeleteOne(ctx, bson.M{"id": idPrimitive})
			if err != nil {
				panic(err)
